...
const floor1Material = new THREE.MeshStandardMaterial({ color: 'black' })
const floor2Material = new THREE.MeshStandardMaterial({ color: 'black' })
const obstacleMaterial = new THREE.MeshStandardMaterial({ color: 'orangered' })
const wallMaterial = new THREE.MeshStandardMaterial({ color: 'black' })

export function BlockStart({ position = [ 0, 1, 0 ] })
{
